  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        >
          <BlurView intensity={90} tint="light" style={styles.modalContentBlur} onStartShouldSetResponder={() => true}>
      ...
      {lastScannedCode && !resultWindowAutoOpen && (
        <View style={[styles.resultWindowButtonContainer, { bottom: Platform.OS === 'ios' ? 140 : insets.bottom + 106 }]}>
          <BlurView intensity={90} tint="light" style={styles.resultWindowButtonBlur}>
