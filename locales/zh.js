...
export default {
  ...
  generator: {
    ...
    barcodeErrors: {
      ...
      upce_numbersystem: 'UPC-E的编号系统必须是0或1',
      // Code系列
      ...
      // 2D条形码
      qrcode_toolong: 'QR Code数据太长',
      datamatrix_toolong: 'Data Matrix数据太长',
