...
export default {
  ...
  settings: {
    ...
    serverUrlInfo: 'Enter server URL (e.g., http://qrcode.com)',
    serverUrl: 'Server URL',
    serverUrlPlaceholder: 'http://qrcode.com',
    connectToServer: 'Connect to Server',
    connected: 'Connected',
    disconnected: 'Disconnected',
    generateSessionUrl: 'Generate Session URL',
    sessionUrlGenerated: 'Session URL Generated',
    copyUrl: 'Copy URL',
    sessionInfo: 'Access this URL to view scanned values in realtime',
    success: 'Success',
    error: 'Error',
