...
export default {
  ...
  auth: {
    ...
    enterNewPassword: 'Enter new password (8+ chars, letters+numbers)',
    enterConfirmPassword: 'Re-enter new password',
    errorCurrentPasswordRequired: 'Please enter your current password',
    errorNewPasswordRequired: 'Please enter your new password',
    errorPasswordLength: 'Password must be at least 6 characters',
    errorPasswordMin8: 'Password must be at least 8 characters.',
    errorPasswordMax100: 'Password cannot exceed 100 characters.',
    errorPasswordLetter: 'Password must contain letters.',
    errorPasswordNumber: 'Password must contain numbers.',
    errorSamePassword: 'New password must be different from current',
    errorCurrentPasswordWrong: 'Current password is incorrect.',
    passwordChangeSuccess: 'Password changed successfully',
    passwordChangeSuccessRelogin: 'Password changed successfully. Please log in again.',
  ...
  exportHistory: {
    ...
    selectedCount: 'Export records from selected groups ({{count}} selected)',
    selectAll: 'Select All',
    deselectAll: 'Deselect All',
    scanRecords: '{{count}} scan records',
    noRecords: 'No records',
    countBadge: '{{count}}',
    exporting: 'Exporting...',
    exportCSV: 'Export as CSV',
    exportTXT: 'Export as TXT',
    alertSelectGroup: 'Please select at least one group to export.',
    fileSaved: 'File saved:',
    exportErrorMsg: 'An error occurred during export.',
    csvHeader: 'Group,Code,Scan Date,Duplicate Count',
    groupLabel: 'Group',
    codeLabel: 'Code',
    scanDateLabel: 'Scan Date',
    duplicateLabel: 'Duplicate Count',
  },
  ...
  termsContent: {
    ...
    article2Content: '① "Service" refers to QR code and barcode scanning, generation, record management, lottery scanning, and other features provided by the App.\n\n② "User" refers to anyone who uses the services provided by the App in accordance with these terms.\n\n③ "Premium Features" refers to additional features that can be unlocked by watching advertisements.',
    ...
    article6Title: 'Article 6 (Advertising and Premium Features)',
    article6Content: '① The App displays advertisements through Google AdMob to support service operation.\n\n② Some premium features can be unlocked by watching rewarded advertisements.\n\n③ Features unlocked through ad viewing are stored on the device and may be reset if the app is deleted.\n\n④ Advertisement content is provided by third parties (Google), and the App is not responsible for ad content.',
    article7Title: 'Article 7 (User Obligations)',
    article7Content: 'Users must not engage in the following activities:\n\n• Theft of others\' information\n• Unauthorized modification of information posted on the App\n• Transmission or posting of information not permitted by the App\n• Infringement of intellectual property rights of the App or third parties\n• Damage to the reputation or business of the App or third parties\n• Fraudulent manipulation of the advertising system\n• Other illegal or improper activities',
    article8Title: 'Article 8 (Disclaimer)',
    article8Content: '① The App is exempt from liability if unable to provide services due to force majeure such as natural disasters, war, or service suspension by telecommunications carriers.\n\n② The App is not responsible for service disruptions caused by user negligence.\n\n③ Lottery result checks are for reference only; official results should be confirmed through official lottery channels.\n\n④ The App has no obligation to intervene in disputes between users or between users and third parties through the service, and is not liable for any resulting damages.',
    article9Title: 'Article 9 (Dispute Resolution)',
    article9Content: '① The App strives to reflect legitimate opinions or complaints raised by users and to compensate for damages.\n\n② Matters not specified in these terms shall be governed by relevant laws and customs.\n\n③ In case of litigation arising from service use, courts of the Republic of Korea shall have exclusive jurisdiction.',
    supplementTitle: 'Supplementary Provisions',
    supplementContent: 'These terms become effective on January 15, 2025.',
  },
  ...
  privacyContent: {
    ...
    section1Content: 'QR Scanner (the "App") processes personal information for the following purposes. Personal information being processed will not be used for purposes other than those listed below, and if the purpose of use changes, necessary measures such as obtaining separate consent will be taken.\n\n• Service provision and operation\n• Scan record storage and management\n• Ad delivery and feature unlock management\n• Service improvement and error analysis\n• Customer inquiry response',
    section2Title: '2. Personal Information Items Collected',
    section2Content: 'The App may collect the following information to provide services:',
    section2Required: 'Required Items',
    section2RequiredItems: '• None (can be used without registration)',
    section2Optional: 'Optional Items',
    section2OptionalItems: '• Email address (during registration)\n• Name/Nickname',
    section2Auto: 'Automatically Collected Items',
    section2AutoItems: '• Device information (device model, OS version)\n• Advertising identifier (for ad delivery)\n• App usage records (with consent)\n• Scan records (stored on device)',
    section3Title: '3. Retention and Use Period of Personal Information',
    section3Content: 'The App destroys personal information without delay after the purpose of collection and use has been achieved.\n\n• Scan records: Stored on device until deleted by user or app deletion\n• Ad viewing records: Stored on device (deleted on app deletion)\n• Analytics data: Up to 2 years after anonymization',
    section4Title: '4. Provision of Personal Information to Third Parties',
    section4Content: 'The App provides personal information to third parties in the following cases:\n\n• Google AdMob: Advertising identifier for ad delivery\n• Firebase Analytics: App usage analysis (with consent)\n\nUsers can withdraw consent for analytics data collection in Settings.',
    ...
    section5ProcedureContent: 'All data stored on the device is automatically deleted when the app is deleted.',
    ...
    section6Content: 'Users may exercise the following rights as personal information subjects:\n\n• Delete scan records: Delete directly from the History tab in the app\n• Withdraw analytics consent: Change in Settings > Analytics Consent\n• Reset advertising identifier: Change in device settings\n• Delete all data: Delete all data by deleting the app',
    ...
    section7OfficerInfo: '• Contact: Development Team\n• Email: qrscanner.app.help@gmail.com',
    ...
    section9Content: 'The App requires permissions for the following features:\n\n• Camera: QR code/barcode scanning, lottery scanning\n• Gallery: Code recognition from images, scan photo saving\n• Notifications: Lottery draw result notifications (optional)\n\nThese permissions are used only to provide the App\'s core features, and data will not be transmitted externally without the user\'s explicit consent.',
    supplementTitle: 'Supplementary Provisions',
    supplementContent: 'This privacy policy becomes effective on January 15, 2025.',
  },
  ...
  security: {
    title: 'Security',
    settingsDesc: 'App lock, biometric settings',
    // App Lock
    enableAppLock: 'Set Up App Lock',
    enableAppLockDesc: 'Protect your app with PIN or biometric authentication',
    disableAppLock: 'Disable App Lock',
    disableAppLockDesc: 'Turn off app lock',
    appLockEnabled: 'App lock has been enabled.',
    appLockDisabled: 'App lock has been disabled.',
    appLockEnableFailed: 'Failed to enable app lock.',
    appLockDisableFailed: 'Failed to disable app lock.',
    // PIN
    changePin: 'Change PIN',
    changePinDesc: 'If you forget your PIN, you will need to log in again from the beginning.',
    enterPin: 'Enter PIN',
    enterNewPin: 'Enter PIN',
    confirmPin: 'Confirm PIN',
    confirmNewPin: 'Confirm New PIN',
    enterCurrentPin: 'Enter Current PIN',
    enterPinToDisable: 'Enter PIN',
    incorrectPin: 'Incorrect PIN.',
    pinMismatch: 'PINs do not match. Please try again.',
    pinChanged: 'PIN has been changed.',
    pinChangeFailed: 'Failed to change PIN.',
    samePinError: 'Please enter a different PIN from your current one.',
    forgotPin: 'Forgot your PIN?',
    cancelSetup: 'Cancel Setup',
    tooManyAttempts: 'Too Many Attempts',
    tooManyAttemptsDesc: 'Please try again later.',
    // Biometric
    useBiometric: 'Use Face ID',
    useBiometricDesc: 'Use Face ID for identity verification.',
    useBiometricTitle: 'Use Face ID',
    useBiometricMessage: 'Would you like to use Face ID for app lock?',
    biometricNotAvailable: 'Biometric Unavailable',
    biometricNotAvailableDesc: 'Biometric authentication is not available on this device. Please set up Face ID or fingerprint in device settings.',
    biometricPrompt: 'Unlock with Face ID',
    toggleBiometricError: 'Failed to change setting.',
    biometric: 'Biometric',
    // Info
    infoText: 'When app lock is enabled, you will need to verify your identity with PIN or biometric authentication when opening the app.',
  },
};
