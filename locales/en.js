...
export default {
  ...
  generator: {
    ...
    barcodeErrors: {
      ...
      tooShort: 'Minimum {{min}} characters required (current: {{current}})',
      tooLong: 'Maximum {{max}} characters allowed (current: {{current}})',
      unknownFormat: 'Unknown barcode format',
      evenDigits: 'Please enter an even number of digits',
      needsEvenLength: 'Even number of characters required (current: {{current}})',
      invalidNumber: 'Only numbers are allowed',
      valueTooSmall: 'Minimum value is {{min}}',
      valueTooLarge: 'Maximum value is {{max}}',
      pharmacodeRange: 'Please enter a number between 3 and 131070',
      invalid: 'Invalid format',
      // bwip-js error message translations
      onlyDigits: 'Only digits are allowed',
      onlyDigitsAndUppercase: 'Only digits and uppercase letters are allowed',
      code93Chars: 'Only digits, uppercase letters, spaces, and symbols (-.$+/) are allowed',
      code39Chars: 'Only digits, uppercase letters, spaces, and symbols (-.$/+%) are allowed',
      code128Chars: 'Only ASCII characters are allowed',
      ...
      tooLongData: 'Input data is too long',
      tooShortData: 'Input data is too short',
      invalidStartStop: 'Invalid start/stop character',
