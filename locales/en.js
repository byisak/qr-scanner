...
export default {
  ...
  generator: {
    ...
    barcodeErrors: {
      ...
      ean13_checkdigit: 'Incorrect EAN-13 check digit',
      ean8_digits: 'EAN-8 must contain only digits',
      ean8_length: 'EAN-8 must be 7 or 8 digits',
      ean8_checkdigit: 'Incorrect EAN-8 check digit',
      ...
      upca_checkdigit: 'Incorrect UPC check digit',
      upce_digits: 'UPC-E must contain only digits',
      upce_length: 'UPC-E must be 7 or 8 digits',
      upce_numbersystem: 'UPC-E must have number system 0 or 1',
      // Code series
      code39_chars: 'Code 39 must contain only digits, capital letters, spaces, and symbols (-.$/+%)',
      code39ext_chars: 'Code 39 Extended must contain only ASCII characters',
      code93_chars: 'Code 93 must contain only digits, capital letters, spaces, symbols (-.$/+), and shift characters',
      code128_chars: 'Code 128 must contain only ASCII characters',
      code11_chars: 'Code 11 must contain only digits and hyphens (-)',
      // ITF series
      ...
      // GS1 series
      gs1_digits: 'GS1 barcode must contain only digits',
      gs1_format: 'Invalid GS1 format',
      ...
      codabar_startstop: 'Codabar requires start/stop characters (A-D)',
      msi_digits: 'MSI must contain only digits',
      plessey_chars: 'Plessey must contain only digits and A-F',
      ...
      // 2D barcodes
      qrcode_toolong: 'QR Code data is too long',
      datamatrix_toolong: 'Data Matrix data is too long',
      pdf417_toolong: 'PDF417 data is too long',
      // ISBN
      isbn_length: 'ISBN-13 must be 15-17 characters, ISBN-10 must be 11-13 characters (including dashes)',
      isbn_checkdigit: 'Incorrect ISBN check digit',
      // Common errors
