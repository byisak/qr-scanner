...
export default {
  ...
  generator: {
    ...
    barcodeErrors: {
      ...
      tooShort: '最低{{min}}文字以上入力してください（現在: {{current}}文字）',
      tooLong: '最大{{max}}文字まで入力可能です（現在: {{current}}文字）',
      unknownFormat: '不明なバーコード形式です',
      evenDigits: '偶数桁を入力してください',
      needsEvenLength: '偶数桁が必要です（現在: {{current}}桁）',
      invalidNumber: '数字のみ入力可能です',
      valueTooSmall: '最小値は{{min}}です',
      valueTooLarge: '最大値は{{max}}です',
      pharmacodeRange: '3〜131070の範囲の数字を入力してください',
      invalid: '形式が正しくありません',
      // bwip-jsエラーメッセージ翻訳
      onlyDigits: '数字のみ入力可能です',
      onlyDigitsAndUppercase: '数字と大文字のみ入力可能です',
      code93Chars: '数字、大文字、スペース、記号(-.$+/)のみ入力可能です',
      code39Chars: '数字、大文字、スペース、記号(-.$/+%)のみ入力可能です',
      code128Chars: 'ASCII文字のみ入力可能です',
      invalidChar: '無効な文字が含まれています',
      invalidLength: '入力の長さが正しくありません',
      invalidCheckDigit: 'チェックディジットが正しくありません',
      mustBeEven: '偶数桁の数字を入力してください',
      tooLongData: '入力データが長すぎます',
      tooShortData: '入力データが短すぎます',
      invalidStartStop: '開始/終了文字が正しくありません',
      outOfRange: '値が許容範囲外です',
    },
    types: {
      website: 'ウェブサイト',
      contact: '連絡先',
