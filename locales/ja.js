...
export default {
  ...
  settings: {
    ...
    serverUrlInfo: 'サーバーアドレスを入力してください (例: http://qrcode.com)',
    serverUrl: 'サーバーアドレス',
    serverUrlPlaceholder: 'http://qrcode.com',
    connectToServer: 'サーバーに接続',
    connected: '接続済み',
    disconnected: '未接続',
    generateSessionUrl: '送信アドレスを生成',
    sessionUrlGenerated: '送信アドレスが生成されました',
    copyUrl: 'URLをコピー',
    sessionInfo: 'このアドレスにアクセスするとリアルタイムでスキャン値を確認できます',
    success: '成功',
    error: 'エラー',
    sessionCreated: 'セッションが作成されました',
    connectionError: '接続に失敗しました',
    enterServerUrl: 'サーバーアドレスを入力してください',
