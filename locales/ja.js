...
export default {
  ...
  generator: {
    ...
    barcodeErrors: {
      ...
      upce_numbersystem: 'UPC-Eはナンバーシステム0または1である必要があります',
      // Code系列
      ...
      // GS1系列
      gs1_digits: 'GS1バーコードは数字のみ入力可能です',
      gs1_format: 'GS1形式が正しくありません',
      ean14_digits: 'EAN-14は数字のみ入力可能です',
      sscc18_digits: 'SSCC-18は数字のみ入力可能です',
      // その他
      codabar_chars: 'Codabarは数字と記号(-$:/.+)のみ入力可能です',
      codabar_startstop: 'Codabarは開始/終了文字(A-D)が必要です',
      msi_digits: 'MSIは数字のみ入力可能です',
      plessey_chars: 'Plesseyは数字とA-Fのみ入力可能です',
      ...
      // 2Dバーコード
      qrcode_toolong: 'QR Codeデータが長すぎます',
      datamatrix_toolong: 'Data Matrixデータが長すぎます',
