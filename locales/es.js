...
export default {
  ...
  generator: {
    ...
    barcodeErrors: {
      ...
      tooShort: 'Mínimo {{min}} caracteres requeridos (actual: {{current}})',
      tooLong: 'Máximo {{max}} caracteres permitidos (actual: {{current}})',
      unknownFormat: 'Formato de código de barras desconocido',
      evenDigits: 'Por favor ingresa un número par de dígitos',
      needsEvenLength: 'Se requiere un número par de caracteres (actual: {{current}})',
      invalidNumber: 'Solo se permiten números',
      valueTooSmall: 'El valor mínimo es {{min}}',
      valueTooLarge: 'El valor máximo es {{max}}',
      pharmacodeRange: 'Por favor ingresa un número entre 3 y 131070',
      invalid: 'Formato inválido',
      // Traducciones de mensajes de error bwip-js
      onlyDigits: 'Solo se permiten dígitos',
      onlyDigitsAndUppercase: 'Solo se permiten dígitos y letras mayúsculas',
      code93Chars: 'Solo se permiten dígitos, mayúsculas, espacios y símbolos (-.$+/)',
      code39Chars: 'Solo se permiten dígitos, mayúsculas, espacios y símbolos (-.$/+%)',
      code128Chars: 'Solo se permiten caracteres ASCII',
      invalidChar: 'Carácter inválido detectado',
      invalidLength: 'Longitud de entrada inválida',
      invalidCheckDigit: 'Dígito de verificación inválido',
      mustBeEven: 'Por favor ingresa un número par de dígitos',
      tooLongData: 'Los datos de entrada son demasiado largos',
      tooShortData: 'Los datos de entrada son demasiado cortos',
      invalidStartStop: 'Carácter de inicio/fin inválido',
