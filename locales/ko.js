...
export default {
  ...
  settings: {
    ...
    serverUrlInfo: '서버 주소를 입력하세요 (예: http://qrcode.com)',
    serverUrl: '서버 주소',
    serverUrlPlaceholder: 'http://qrcode.com',
    connectToServer: '서버 연결',
    connected: '연결됨',
    disconnected: '연결 안됨',
    generateSessionUrl: '전송주소 생성',
    sessionUrlGenerated: '전송주소가 생성되었습니다',
    copyUrl: 'URL 복사',
    sessionInfo: '이 주소로 접속하면 실시간으로 스캔 값을 확인할 수 있습니다',
    success: '성공',
    error: '오류',
    sessionCreated: '세션이 생성되었습니다',
    connectionError: '연결에 실패했습니다',
    enterServerUrl: '서버 주소를 입력해주세요',
    notConnected: '서버에 연결되지 않았습니다',
