...
export default {
  ...
  // 서비스 이용약관
  termsContent: {
    lastUpdated: '최종 업데이트: 2024년 12월 24일',
    ...
    supplementTitle: '부칙',
    supplementContent: '이 약관은 2024년 12월 24일부터 시행합니다.',
  },
  ...
  privacyContent: {
    ...
    section2Content: '앱은 서비스 제공을 위해 다음과 같은 개인정보를 수집할 수 있습니다:',
    section2Required: '필수 항목',
    section2RequiredItems: '• 이메일 주소 (회원가입 시)\n• 비밀번호',
    section2Optional: '선택 항목',
    section2OptionalItems: '• 이름/닉네임\n• 프로필 이미지',
    section2Auto: '자동 수집 항목',
    section2AutoItems: '• 기기 정보 (기기 모델, OS 버전)\n• 앱 사용 기록\n• 스캔 기록 (사용자 동의 시)',
    section3Title: '3. 개인정보의 보유 및 이용 기간',
    section3Content: '앱은 개인정보 수집 및 이용 목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 관계 법령의 규정에 의하여 보존할 필요가 있는 경우 앱은 아래와 같이 관계 법령에서 정한 일정한 기간 동안 회원정보를 보관합니다.\n\n• 계약 또는 청약철회 등에 관한 기록: 5년\n• 대금결제 및 재화 등의 공급에 관한 기록: 5년\n• 소비자의 불만 또는 분쟁처리에 관한 기록: 3년\n• 접속에 관한 기록: 3개월',
    section4Title: '4. 개인정보의 제3자 제공',
    section4Content: '앱은 원칙적으로 이용자의 개인정보를 외부에 제공하지 않습니다. 다만, 아래의 경우에는 예외로 합니다:\n\n• 이용자가 사전에 동의한 경우\n• 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우',
    ...
    section5ProcedureContent: '이용자가 입력한 정보는 목적 달성 후 별도의 DB에 옮겨져 내부 방침 및 기타 관련 법령에 따라 일정기간 저장된 후 혹은 즉시 파기됩니다.',
    ...
    section9Content: '앱은 QR코드 및 바코드 스캔 기능을 제공하기 위해 카메라 접근 권한이 필요합니다. 또한, 이미지에서 코드를 인식하기 위해 갤러리 접근 권한이 필요할 수 있습니다.\n\n이러한 권한은 오직 앱의 핵심 기능 제공을 위해서만 사용되며, 사용자의 명시적 동의 없이 사진이나 영상이 수집, 저장 또는 전송되지 않습니다.',
    supplementTitle: '부칙',
