...
export default {
  ...
  generator: {
    ...
    barcodeErrors: {
      ...
      tooShort: '최소 {{min}}자리 이상 입력해주세요 (현재: {{current}}자리)',
      tooLong: '최대 {{max}}자리까지 입력 가능합니다 (현재: {{current}}자리)',
      unknownFormat: '알 수 없는 바코드 형식입니다',
      evenDigits: '짝수 자릿수를 입력해주세요',
      needsEvenLength: '짝수 자릿수가 필요합니다 (현재: {{current}}자리)',
      invalidNumber: '숫자만 입력 가능합니다',
      valueTooSmall: '최소값은 {{min}}입니다',
      valueTooLarge: '최대값은 {{max}}입니다',
      pharmacodeRange: '3~131070 범위의 숫자를 입력해주세요',
      invalid: '올바른 형식이 아닙니다',
      // bwip-js 에러 메시지 번역
      onlyDigits: '숫자만 입력 가능합니다',
      onlyDigitsAndUppercase: '숫자와 대문자만 입력 가능합니다',
      code93Chars: '숫자, 대문자, 공백, 특수문자(-.$+/)만 입력 가능합니다',
      code39Chars: '숫자, 대문자, 공백, 특수문자(-.$/+%)만 입력 가능합니다',
      code128Chars: 'ASCII 문자만 입력 가능합니다',
      invalidChar: '허용되지 않는 문자가 포함되어 있습니다',
      invalidLength: '입력 길이가 올바르지 않습니다',
      invalidCheckDigit: '체크섬이 올바르지 않습니다',
      mustBeEven: '짝수 개의 숫자를 입력해주세요',
      tooLongData: '입력 데이터가 너무 깁니다',
      tooShortData: '입력 데이터가 너무 짧습니다',
      invalidStartStop: '시작/종료 문자가 올바르지 않습니다',
      outOfRange: '값이 허용 범위를 벗어났습니다',
    },
    types: {
      website: '웹 사이트',
      contact: '연락처',
