...
const FRAME_QR_POSITIONS = {
  'scan-me': { x: 7, y: 97, width: 277, height: 283, viewBoxWidth: 292, viewBoxHeight: 395 },
};
...
export default function QRFrameRenderer({
  ...
  // QR 코드 크기를 영역에 맞게 조정 (프레임과 겹치지 않도록 여백 확보)
  const qrSize = Math.floor(Math.min(qrAreaWidth, qrAreaHeight) * 0.85);
