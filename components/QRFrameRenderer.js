...
// viewBox를 실제 콘텐츠 영역에 맞게 크롭 (정사각형 380x380)
const FRAME_SVG_DATA = {
  'scan-me': `<svg viewBox="160 158 380 380" xmlns="http://www.w3.org/2000/svg">
...
<rect x="212" y="252" width="277" height="283" fill="#FFFFFF"/>
</svg>`,
};

// QR 코드 위치 정보 (크롭된 viewBox 기준) - 흰색 영역
// viewBox "160 158 380 380" 기준으로 좌표 변환: x-160, y-158
const FRAME_QR_POSITIONS = {
  'scan-me': { x: 52, y: 94, width: 277, height: 283, viewBoxSize: 380 },
};
...
export default function QRFrameRenderer({
  ...
  // 프레임 비율 계산 (크롭된 viewBox 기준)
  const viewBoxSize = qrPosition.viewBoxSize || 700;
